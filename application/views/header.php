                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="<?php echo $base.'Checkout/co';?>" class="nav-item nav-link">Checkout</a>
                            <a href="<?php echo $base.'My_account/myaccount';?>" class="nav-item nav-link">My Account</a>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">More Pages</a>
                                <div class="dropdown-menu">
                                    <a href="<?php echo $base.'Wish_list/wishlist';?>" class="dropdown-item">Wishlist</a>
                                    
                                    <a href="<?php echo $base.'Contact/contect';?>" class="dropdown-item">Contact Us</a>
                                </div>
                            </div>
                        </div>
